...
public class InventoryManager : MonoBehaviour
{
    ...
    public void ToggleRuneInventoryUI()
    {
        _runeInventoryUI.gameObject.SetActive(!_runeInventoryUI.gameObject.activeSelf);
    }

    public void ToggleEquipInventoryUI()
    {
        _equipInventoryUI.gameObject.SetActive(!_equipInventoryUI.gameObject.activeSelf);
    }
}
